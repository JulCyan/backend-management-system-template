...
export abstract class HttpResponseService implements AjaxResponseService {
    abstract handler(response: ImplementAxiosResponse): void | ImplementAxiosResponse | IBusinessData
}

// Http 成功状态码 ResponseService
export class SuccessHttpStatusService implements HttpResponseService {
  handler(response: ImplementAxiosResponse): void | ImplementAxiosResponse | IBusinessData {
...
export class ServerErrorHttpStatusService implements HttpResponseService {
  handler(response: ImplementAxiosResponse): void | ImplementAxiosResponse {
...
export class HttpStatusServicesFactory {
    private static handlerMap: Map<Array<BaseNS>, HttpResponseService> = new Map([
      [SuccessHttpStatus, new SuccessHttpStatusService()],
      [SuccessHttpStatus, new UnauthorizedHttpStatusService()],
      [SuccessHttpStatus, new ServerErrorHttpStatusService()]
    ])
